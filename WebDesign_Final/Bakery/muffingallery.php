		...
		<div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="../Deli/about.php">About Us</a>
                    </li>
                    <li>
					...
					<li>
                        <a href="../Deli/deli.php">Deli</a>
                    </li>
					<li>
                        <a href="../Grocery/grocery.html">Groceries</a>
                    </li>
                    <li>
                        <a href="../Grocery/contact.php">Contact US</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                     <p> <a href="../Grocery/tandc.html"> Terms & Conditions </a> &copy; 2016 Wollaston's </p>
                </div>
            </div>
        </div>
    </footer>
